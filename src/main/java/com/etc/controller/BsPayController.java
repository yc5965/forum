...
import com.etc.common.AlipayConfig;
...
@Controller
@RequestMapping("bsPay")
public class BsPayController {
    @Autowired
    private BsUserService bsUserService;

    @RequestMapping(value = "/alipaySum/{price}" ,produces = "text/html; charset=UTF-8")
    @ResponseBody
    public Object alipayIumpSum(HttpServletResponse response, @PathVariable("price") String price)
            throws Exception {
        String subject="会员充值";
        String body ="支付宝沙箱模式充值会员";
        // 获得初始化的AlipayClient
    ...
    public ModelAndView alipayReturnNotice(HttpServletRequest request, HttpServletRequest response) throws Exception {
        ...
        if(signVerified) {
            ...
            bsUserService.updateUserType("2",total_amount);
        }else {
