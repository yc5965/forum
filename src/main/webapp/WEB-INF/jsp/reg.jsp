  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title">
        <li><a href="${ctx}/login/loginIndex">登录</a></li>
        ...
        <div class="layui-tab-item layui-show">
          <div class="layui-form layui-form-pane">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-form-mid layui-word-aux" style="color: red" id="L_username_ver"></div>
              </div>
              <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                <button class="layui-btn" id="regsubmit">立即注册</button>
              </div>
          </div>
        </div>
      </div>
  ...
  layui.use(['jquery', 'layer', 'laytpl', 'util', 'form', 'fly','element'], function() {
    ...
    $("#regsubmit").click(function () {
      ...
      if(reg.test($("#L_email").val())==false){
        $("#L_email_ver").text("Email格式不正确");
        return false;
      }else if($("#L_username").val()==null||$("#L_username").val()==""||$("#L_username").val()==null||$("#L_username").val()==" "){
        $("#L_username_ver").text("昵称不能为空");
        return false;
        ...
        $.ajax({
          url:"${ctx}/login/regUser",
          type:"POST",
          data:{"email":$("#L_email").val(),"name":$("#L_username").val(),"password":$("#L_pass").val()},
          success:function(r){
            if (r.data=='成功') {
                layer.msg("注册成功！");
              ...
              $("#L_email_ver").text("该邮箱已注册");
            }else if(r.data=='昵称'){
                $("#L_name_ver").text("该昵称已存在");
            }
          }
        })
    })
